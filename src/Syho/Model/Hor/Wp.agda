...
abstract
  ...
  ⁺⟨⟩ᴾᵒ-eatˡ {vk = ĩ₁ _} Q∗⟨kr⟩P =  ⁺⟨⟩ᴾᵒ-kr λ M → Q∗⟨kr⟩P ▷
    ∗ᵒ-monoʳ (⁺⟨⟩ᴾᵒ-kr⁻¹ › (_$ M) › ⇛ᵒ'⇒⇛ᵒ) ▷ ⇛ᵍ-eatˡ ▷ (⇛ᵍ-mono $ ∗ᵒ∃ᵒ-out ›
    λ (krM⇒ , big) → krM⇒ , λ e M' krM⇒eM' → big ▷
    ∗ᵒ-monoʳ (λ big → big e M' krM⇒eM' ▷ ⇛ᵒ'⇒⇛ᵒ) ▷ ⇛ᵍ-eatˡ ▷ ⇛ᵍ-mono go ▷
    ⇛ᵒ⇒⇛ᵒ') ▷ ⇛ᵒ⇒⇛ᵒ'
   where
...
abstract
  ...
  ⁺⟨⟩ᵀᵒ⇒⁺⟨⟩ᴾᵒ (⁺⟨⟩ᵀᵒ-kr big) =  ⁺⟨⟩ᴾᵒ-kr λ M → big M ▷ ⇛ᵒ'⇒⇛ᵒ ▷ (⇛ᵍ-mono
    λ (krM⇒ , big) → krM⇒ , λ e M' krM⇒eM' → big e M' krM⇒eM' ▷ ⇛ᵒ'⇒⇛ᵒ ▷
    ⇛ᵍ-mono go ▷ ⇛ᵒ⇒⇛ᵒ') ▷ ⇛ᵒ⇒⇛ᵒ'
   where
  ...
  ⁺⟨⟩ᵀᵒ-eatˡ {vk = ĩ₁ _} Q∗⟨kr⟩P =  ⁺⟨⟩ᵀᵒ-kr λ M → Q∗⟨kr⟩P ▷
    ∗ᵒ-monoʳ (⁺⟨⟩ᵀᵒ-kr⁻¹ › (_$ M) › ⇛ᵒ'⇒⇛ᵒ) ▷ ⇛ᵍ-eatˡ ▷ (⇛ᵍ-mono $ ∗ᵒ∃ᵒ-out ›
    λ (krM⇒ , big) → krM⇒ , λ e M' krM⇒eM' → big ▷
    ∗ᵒ-monoʳ (λ big → big e M' krM⇒eM' ▷ ⇛ᵒ'⇒⇛ᵒ) ▷ ⇛ᵍ-eatˡ ▷ ⇛ᵍ-mono go ▷
    ⇛ᵒ⇒⇛ᵒ') ▷ ⇛ᵒ⇒⇛ᵒ'
   where
