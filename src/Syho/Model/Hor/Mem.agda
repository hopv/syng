...
abstract
  ...
  ⁺⟨⟩ᴾᵒ-🞰 :  θ ↦⟨ p ⟩ᵒ (T , v)  ∗ᵒ  Pᵒ  ⊨  ⟨ K ᴷ◁ V⇒E {T} v ⟩ᴾᵒ[ ι ]  Qᵒ˙ →
             θ ↦⟨ p ⟩ᵒ (T , v)  ∗ᵒ  Pᵒ  ⊨  ⁺⟨ ĩ₁ (-, K , 🞰ᴿ θ) ⟩ᴾᵒ[ ι ]  Qᵒ˙
  ...
  ⁺⟨⟩ᵀᵒ-🞰 :  θ ↦⟨ p ⟩ᵒ (T , v)  ∗ᵒ  Pᵒ  ⊨  ⟨ K ᴷ◁ V⇒E {T} v ⟩ᵀᵒ[ ι ]  Qᵒ˙ →
             θ ↦⟨ p ⟩ᵒ (T , v)  ∗ᵒ  Pᵒ  ⊨  ⁺⟨ ĩ₁ (-, K , 🞰ᴿ θ) ⟩ᵀᵒ[ ∞ ]  Qᵒ˙
  ...
  ⁺⟨⟩ᴾᵒ-← :  θ ↦ᵒ (T , v)  ∗ᵒ  Pᵒ  ⊨  ⟨ K ᴷ◁ ∇ _ ⟩ᴾᵒ[ ι ]  Qᵒ˙ →
             θ ↦ᵒ ᵗu  ∗ᵒ  Pᵒ  ⊨  ⁺⟨ ĩ₁ (-, K , _←ᴿ_ {T} θ v) ⟩ᴾᵒ[ ι ]  Qᵒ˙
  ⁺⟨⟩ᴾᵒ-← θ↦v∗P⊨⟨K∇⟩Q θ↦u∗Pa =  ⁺⟨⟩ᴾᵒ-kr λ M → θ↦u∗Pa ▷ ∗ᵒ-monoˡ ↦⟨⟩ᵒ-read ▷
    ⇛ᵒ-eatʳ ▷ ⇛ᵒ-mono $ ∃ᵒ∗ᵒ-out › λ (M‼θ≡u , θ↦u∗Pb) →
    (-, redᴷᴿ $ ←⇒ (-, M‼θ≡u)) , λ{ _ _ _ (redᴷᴿ (←⇒ _)) → θ↦u∗Pb ▷
    ∗ᵒ-monoˡ ↦ᵒ-write ▷ ⇛ᵒ-eatʳ ▷
    ⇛ᵒ-mono λ θ↦u∗Pb → ∗ᵒ?-intro _ $ λ{ .! → θ↦v∗P⊨⟨K∇⟩Q θ↦u∗Pb }}

  ⁺⟨⟩ᵀᵒ-← :  θ ↦ᵒ (T , v)  ∗ᵒ  Pᵒ  ⊨  ⟨ K ᴷ◁ ∇ _ ⟩ᵀᵒ[ ι ]  Qᵒ˙ →
             θ ↦ᵒ ᵗu  ∗ᵒ  Pᵒ  ⊨  ⁺⟨ ĩ₁ (-, K , _←ᴿ_ {T} θ v) ⟩ᵀᵒ[ ∞ ]  Qᵒ˙
  ⁺⟨⟩ᵀᵒ-← θ↦v∗P⊨⟨K∇⟩Q θ↦u∗Pa =  ⁺⟨⟩ᵀᵒ-kr λ M → θ↦u∗Pa ▷ ∗ᵒ-monoˡ ↦⟨⟩ᵒ-read ▷
    ⇛ᵒ-eatʳ ▷ ⇛ᵒ-mono $ ∃ᵒ∗ᵒ-out › λ (M‼θ≡u , θ↦u∗Pb) →
    (-, redᴷᴿ $ ←⇒ (-, M‼θ≡u)) , λ{ _ _ _ (redᴷᴿ (←⇒ _)) → θ↦u∗Pb ▷
    ∗ᵒ-monoˡ ↦ᵒ-write ▷ ⇛ᵒ-eatʳ ▷ ⇛ᵒ-mono λ θ↦u∗Pb →
    ∗ᵒ?-intro _ $ § θ↦v∗P⊨⟨K∇⟩Q θ↦u∗Pb }
