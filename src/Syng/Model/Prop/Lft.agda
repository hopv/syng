...
module Syng.Model.Prop.Lft where
...
open import Base.Ratp using (ℚ⁺; 1ᴿ⁺; _≈ᴿ⁺_; _+ᴿ⁺_; _≤1ᴿ⁺; _/2⁺; /2⁺-merge;
  /2⁺-split)
open import Syng.Logic.Prop using (Lft)
open import Syng.Model.ERA.Lft using ([_]ᴸ⟨_⟩ʳ; †ᴸʳ_; ◠˜ᴸᶠᵗ_; []ᴸ⟨⟩ʳ-cong;
  []ᴸ⟨⟩ʳ-∙; []ᴸ⟨⟩ʳ-≤1; †ᴸʳ-⌞⌟; []ᴸ⟨⟩ʳ-†ᴸʳ-no; []ᴸʳ-new; []ᴸʳ-kill)
open import Syng.Model.ERA.Glob using (iᴸᶠᵗ)
open import Syng.Model.Prop.Base using (SPropᵒ; _⊨✓_; _⊨_; ⊨_; ∃ᵒ-syntax; ⌜_⌝ᵒ;
