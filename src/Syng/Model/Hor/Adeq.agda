...
module Syng.Model.Hor.Adeq where
...
open import Syng.Lang.Expr using (Type; ◸_; Expr∞; Val; V⇒E; Heap; ✓ᴴ_)
open import Syng.Lang.Ktxred using (Ktxred; val/ktxred; val/ktxred-ĩ₀;
  val/ktxred-V⇒E)
open import Syng.Lang.Reduce using ([]⇒; redᴷᴿ; _⇒ᴷᴿ∑; redᴱ; _⇒ᵀ_; _⇒ᵀ○_; _⇒ᵀ●_;
  redᵀ-hd; redᵀ-tl; _⇒ᵀ*_; ⇒ᵀ*-refl; ⇒ᵀ*-step; SNᵀ; Infᵀ; infᵀ)
open import Syng.Model.ERA.Glob using (Resᴳ; _✓ᴳ_; Envᴵⁿᴳ; envᴳ; ∅ᴵⁿᴳ-✓ᴺ)
...
open import Syng.Model.Fupd.Interp using (⟨_⟩⇛ˢ⟨_⟩_; Invᴳ; Invᴳ-∅; ⇛ˢ-Mono;
  ⇛ˢ-mono✓; ⇛ˢ-mono; ⊨✓⇒⊨-⇛ˢ; ⇛ˢ-intro; ⇛ˢ-join; ⇛ˢ-eatˡ; ⇛ˢ-eatʳ; ⇛ˢ-adeq;
  ⇛ˢ-step)
open import Syng.Model.Hor.Wp using (⁺⟨_⟩ᴾᵒ; ⟨_⟩ᴾᵒ; ⟨_⟩ᵀᵒ; ⟨_⟩∞ᵒ; ⟨_⟩ᵀᵒ˂;
