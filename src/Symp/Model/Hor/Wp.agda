...
-- Wpg' is a variant of Wpg that uses the concrete connectives ⇛ᴴ', -∗ᵒ' and
...
Wpg Wpg' :  Ktxred T →  (Expr∞ T → ¿ Expr∞ (◸ ⊤) → 𝔹 → SPropᵒ ł) →
            SPropᵒ (1ᴸ ⊔ᴸ ł)
Wpg kr Pᵒ˙³ =  [⊤]ᴺᵒ -∗ᵒ ∀ᵒ H , ⟨ H ⟩⇛ᴴ⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
  ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ∀ᵒ b , ⌜ (e , eˇ , H') ⇐ᴷᴿ⟨ b ⟩ (kr , H) ⌝ᵒ→
    ⟨ H ⟩⇛ᴴ⟨ H' ⟩ [⊤]ᴺᵒ ∗ᵒ Pᵒ˙³ e eˇ b
Wpg' kr Pᵒ˙³ =  [⊤]ᴺᵒ -∗ᵒ' ∀ᵒ H , ⟨ H ⟩⇛ᴴ'⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
  ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ∀ᵒ b , ⌜ (e , eˇ , H') ⇐ᴷᴿ⟨ b ⟩ (kr , H) ⌝ᵒ→
    ⟨ H ⟩⇛ᴴ'⟨ H' ⟩ [⊤]ᴺᵒ ∗ᵒ' Pᵒ˙³ e eˇ b
...
abstract
  ...
  Wpg⇒Wpg' =  -∗ᵒ-monoʳ (λ big H → big H ▷ (⇛ᴴ-mono λ (krH⇒ , big) → krH⇒ ,
    λ e eˇ H' b eeˇH'⇐b → big e eˇ H' b eeˇH'⇐b ▷ ⇛ᴴ-mono ∗ᵒ⇒∗ᵒ' ▷ ⇛ᴴ⇒⇛ᴴ') ▷
    ⇛ᴴ⇒⇛ᴴ') › -∗ᵒ⇒-∗ᵒ'

  Wpg'⇒Wpg :  Wpg' kr Pᵒ˙³  ⊨  Wpg kr Pᵒ˙³
  Wpg'⇒Wpg =  -∗ᵒ'⇒-∗ᵒ {Qᵒ = ∀ᵒ H , ⟨ H ⟩⇛ᴴ'⟨ H ⟩ _} ›
    -∗ᵒ-monoʳ λ big H → big H ▷ ⇛ᴴ'⇒⇛ᴴ ▷ ⇛ᴴ-mono λ (krH⇒ , big) → krH⇒ ,
    λ e eˇ H' b eeˇH'⇐b → big e eˇ H' b eeˇH'⇐b ▷ ⇛ᴴ'⇒⇛ᴴ ▷ ⇛ᴴ-mono ∗ᵒ'⇒∗ᵒ

  -- Monotonicity of Wpg

  Wpg-mono :  (∀{e eˇ b} →  Pᵒ˙³ e eˇ b  ⊨  Qᵒ˙³ e eˇ b)  →
                Wpg kr Pᵒ˙³  ⊨  Wpg kr Qᵒ˙³
  Wpg-mono Peeˇb⊨Qeeˇb =  -∗ᵒ-monoʳ (λ big H → big H ▷ ⇛ᴴ-mono
    λ (krH⇒ , big) → krH⇒ , λ e eˇ H' b eeˇH'⇐b → big e eˇ H' b eeˇH'⇐b ▷
    ⇛ᴴ-mono (∗ᵒ-monoʳ Peeˇb⊨Qeeˇb))
  ...
  ⇛ᴺᵒ-Wpg =  -∗ᵒ-monoʳ λ big H → big H ▷
    ⇛ᴴ-mono✓ (λ ✓∙ → -∗ᵒ-applyˡ ∀ᵒ⇛ᴴ-Mono ✓∙ › _$ H) ▷ ⇛ᴴ-join
  ...
  Wpg-eatˡ =  -∗ᵒ-eatˡ ∀ᵒ⇛ᴴ-Mono › -∗ᵒ-monoʳ λ big H → big ▷ ∗ᵒ-monoʳ (_$ H) ▷
    ⇛ᴴ-eatˡ ▷ ⇛ᴴ-mono (∗ᵒ∃ᵒ-out › λ (krH⇒ , big) → krH⇒ , λ e eˇ H' b eeˇH'⇐b →
    big ▷ ∗ᵒ-monoʳ (λ big → big e eˇ H' b eeˇH'⇐b) ▷ ⇛ᴴ-eatˡ ▷ ⇛ᴴ-mono ?∗ᵒ-comm)
