...
open import Syho.Model.ERA.Glob using (iᴹᵉᵐ; outᴳ; Envᴵⁿᴳ˙; empᴵⁿᴳ; empᴵⁿᴳ-✓;
  upd˙-out-envᴳ)
open import Syho.Model.Prop.Base using (Propᵒ; Monoᵒ; _⊨✓_; _⊨_; ⊨_; ∀ᵒ-syntax;
  ⊤ᵒ; ⊤ᵒ₀; ⌜_⌝ᵒ; ⌜_⌝ᵒ×_; _∗ᵒ'_; _∗ᵒ_; _-∗ᵒ'_; _-∗ᵒ_; ⤇ᵒ_; _⤇ᴱ'_; _⤇ᴱ_; ⊨⇒⊨✓;
  substᵒ; ∀ᵒ-Mono; ∀ᵒ-mono; ∀ᵒ-intro; ∗ᵒ≡∗ᵒ'; ∗ᵒ-mono✓ˡ; ∗ᵒ-monoˡ; ∗ᵒ-monoʳ;
  ∗ᵒ-comm; ∗ᵒ-assocˡ; ∗ᵒ-assocʳ; ∗ᵒ?-intro; ∃ᵒ∗ᵒ-out; -∗ᵒ≡-∗ᵒ'; -∗ᵒ-Mono;
  -∗ᵒ-monoʳ; -∗ᵒ-intro; -∗ᵒ-apply; ⤇ᵒ-intro; ⤇ᴱ≡⤇ᴱ'; ⤇ᴱ-Mono; ⤇ᴱ-mono✓; ⤇ᴱ-mono;
  ⤇ᴱ-respᴱˡ; ⤇ᴱ-respᴱʳ; ⤇ᴱ-param; ⤇ᵒ⇒⤇ᴱ; ⤇ᴱ-intro-✓; ⤇ᵒ-eatʳ; ⤇ᴱ-join; ⤇ᴱ-eatˡ;
  ⤇ᴱ-eatʳ; ⊨✓⇒⊨-⤇ᴱ; ⤇ᴱ-adeq)
...
[_]⇛ᵍ¹_ :  (∑ j , (Envᴵⁿᴳ˙ j → Propᵒ ł)) →  Propᵒ ł' →
  Propᵒ (1ᴸ ⊔ᴸ ł ⊔ᴸ ł')
...
abstract
  ...
  ⇛ᵍ-make {Pᵒ = Pᵒ} P∗Inv⊨⤇Q∗Inv =
    ∀ᵒ-intro {Pᵒ = Pᵒ} λ _ → -∗ᵒ-intro λ _ → ∗ᵒ-comm › P∗Inv⊨⤇Q∗Inv
