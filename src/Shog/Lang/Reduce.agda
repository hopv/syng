...
open import Shog.Lang.Expr ℓ using (Expr*; ▸_; ∇*_; λ*˙; _◁_; *ᴱ_; _←ᴱ_)
...
...   | none =  some $ _ , id , (e ◁ e')
evctx-redex (*ᴱ e)  with evctx-redex e
... | some (_ , eᶜ , eʳ) =  some $ _ , (λ e₀ → *ᴱ eᶜ e₀) , eʳ
... | none =  some $ _ , id , *ᴱ e
evctx-redex (e ←ᴱ e')  with  evctx-redex e'
... | some (_ , e'ᶜ , e'ʳ) =  some $ _ , (λ e₀ → e ←ᴱ e'ᶜ e₀) , e'ʳ
... | none  with evctx-redex e
...   | some (_ , eᶜ , eʳ) =  some $ _ , (λ e₀ → eᶜ e₀ ←ᴱ e') , eʳ
...   | none =  some $ _ , id , (e ←ᴱ e')
