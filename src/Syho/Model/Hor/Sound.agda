...
abstract
  ...
  ⊢⁺⟨⟩ᵀ-sem (ahorᴺ-hor P⊢⟨red⟩ᴺQ Qv⊢⟨Kv⟩R) =  -∗ᵒ-intro (λ _ → ∗ᵒ-comm ›
...
abstract
  ...
  -- ahorᴺ-ihor :  P ∗ [⊤]ᴺ  ⊢[ ∞ ][ i ]ᵃ⟨ red ⟩ (λ v →  Q˙ v ∗ [⊤]ᴺ)  →
  --               (∀ v →  Q˙ v  ⊢[ ∞ ][ j ]⟨ K ᴷ◁ V⇒E v ⟩∞)  →
  --               P  ⊢[ ∞ ][ j ]⁺⟨ ĩ₁ (-, K , red) ⟩∞

  ⊢⁺⟨⟩∞-sem (ahorᴺ-ihor P⊢⟨red⟩ᴺQ Qv⊢⟨Kv⟩∞) =  -∗ᵒ-intro (λ _ → ∗ᵒ-comm ›
...
abstract
  ...
  ⊢⁺⟨⟩ᴾ-sem (ahorᴺ-hor P⊢⟨red⟩ᴺQ Qv⊢⟨Kv⟩R) =  -∗ᵒ-intro (λ _ → ∗ᵒ-comm ›
