...
open import Syng.Logic.Prop using (Name; SProp∞; _∗_; ⤇_; [_]ᴺ)
open import Syng.Logic.Core using (_⊢[_]_; ⇒<; ⊢-refl; _»_; ∗-monoˡ; ∗-comm;
  ∗-assocˡ; ∗-assocʳ; ∗?-comm; -∗-applyˡ; ⤇-intro)
open import Syng.Logic.Names using ([]ᴺ-⊆--∗)

-- Import and re-export
open import Syng.Logic.Judg public using ([_]⇛_; _⊢[_][_]⇛_; _⊢[<_][_]⇛_;
