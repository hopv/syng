...
open import Syho.Model.Prop.Base using (Propᵒ; substᵒ; _⊨_; ∀ᵒ∈-syntax; _∗ᵒ_;
  _-∗ᵒ_; ∗ᵒ-mono; ∗ᵒ-monoˡ; ∗ᵒ-monoʳ; ∗ᵒ?-intro; -∗ᵒ-monoʳ; -∗ᵒ-introˡ;
...
abstract
  ...
  ⁺⟨⟩∞ᵒ-[]○ =  -∗ᵒ-introˡ (λ _ big _ → ⇛ᴹ-intro ((-, -, redᴷᴿ []⇒) ,
