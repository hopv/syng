...
module Syng.Model.ERA.Ub where
...
open import Syng.Model.ERA.Exc using (Exc; εˣ; #ˣ_; ↯ˣ; _∙ˣ_; ∙ˣ-comm;
  ∙ˣ-assocʳ)
import Syng.Model.ERA.Fin
...
module FinUb =  Syng.Model.ERA.Fin Ubbᴱᴿᴬ (λ{u} → ≡εᵁᵇᵇ-rem {u})
