...
abstract
  ...
  ⁺⟨⟩ᴾᵒ-eatˡ {vk = ĩ₀ _} =  ∗ᵒ-monoʳ ⁺⟨⟩ᴾᵒ-val⁻¹ › -∗ᵒ-eatˡ ∀ᵒ⇛ᴹ-Mono ›
  ...
  ⁺⟨⟩ᵀᵒ-eatˡ {vk = ĩ₀ _} =  ∗ᵒ-monoʳ ⁺⟨⟩ᵀᵒ-val⁻¹ › -∗ᵒ-eatˡ ∀ᵒ⇛ᴹ-Mono ›
