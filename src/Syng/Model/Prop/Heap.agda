...
module Syng.Model.Prop.Heap where
...
open import Base.Ratp using (ℚ⁺; 1ᴿ⁺; _≈ᴿ⁺_; _+ᴿ⁺_; _≤1ᴿ⁺; _/2⁺; /2⁺-merge;
  /2⁺-split)
open import Syng.Lang.Expr using (Addr; _ₒ_; TyVal; ⊤-; Heap; _‼ᴴ_; updᴴ)
open import Syng.Model.ERA.Heap using (Heapᴱᴿᴬ; εᴴᵉᵃᵖ; [∙ᴴᵉᵃᵖ∈ⁱ]-syntax;
  [∙ᴴᵉᵃᵖ∈ⁱ⟨⟩]-syntax; ◠˜ᴴᵉᵃᵖ_; _↦⟨_⟩ʳ_; _↦ʳ_; freeʳ; _↦ᴸʳ_; ↦⟨⟩ʳ-cong; ↦⟨⟩ʳ-∙;
  ↦⟨⟩ʳ-≤1; ↦⟨⟩ʳ-agree; [∙∈ⁱ]↦≈↦ᴸʳ; ↦⟨⟩ʳ-read; ↦ʳ-write; ↦ᴸʳ-alloc; freeʳ-š;
  ↦ᴸʳ-free)
open import Syng.Model.ERA.Glob using (iᴴᵉᵃᵖ)
