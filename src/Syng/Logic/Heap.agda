...
open import Syng.Lang.Expr using (Addr; Type; ◸ʸ_; ∇_; V⇒E; TyVal; ⊤-)
open import Syng.Lang.Ktxred using (🞰ᴿ_; _←ᴿ_; fauᴿ; casᴿ; allocᴿ; freeᴿ; Ktx;
  _ᴷ◁_)
open import Syng.Logic.Prop using (HorKind; par; tot; SProp∞; _∗_; _↦⟨_⟩_; _↦_;
  _↦ᴸ_; Free)
open import Syng.Logic.Core using (_⊢[_]_; _»_; ∗-assocˡ; ∗-assocʳ; ⊤∗-intro;
  ∗-elimʳ; ∃∗-elim)
open import Syng.Logic.Hor using (_⊢[_]⁺⟨_⟩[_]_; _⊢[<ᴾ_]⟨_⟩[_]_; ahor-frameˡ;
  ahor-hor; hor<ᴾ-map)

-- Import and re-export
open import Syng.Logic.Judg public using (↦⟨⟩-resp; ↦⟨⟩-merge; ↦⟨⟩-split;
