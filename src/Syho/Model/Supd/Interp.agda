...
open import Syho.Model.Prop.Base using (Propᵒ; Monoᵒ; _⊨✓_; _⊨_; ⊨_; ⊨⇒⊨✓;
  ...
  ∗ᵒ-monoˡ; ∗ᵒ-mono✓ʳ; ∗ᵒ-comm; ∗ᵒ-assocˡ; ∗ᵒ-assocʳ; ∗ᵒ?-intro; -∗ᵒ-Mono;
  -∗ᵒ-monoʳ; -∗ᵒ-intro; -∗ᵒ-applyʳ; ⤇ᵒ-intro; ⤇ᴱ-param; ⤇ᴱ-eatʳ; ⤇ᴱ-step)
...
abstract
  ...
  ⇛ᴺᵒ-eatˡ =  ⇛ᴺᵒ-make λ ✓∙ → ∗ᵒ-assocˡ › ∗ᵒ-mono✓ʳ (-∗ᵒ-applyʳ ⇛ᵒ-Mono) ✓∙ ›
    ⇛ᵒ-eatˡ › ⇛ᵒ-mono ∗ᵒ-assocʳ

  ⇛ᴺᵒ-eatʳ :  (⇛ᴺᵒ Pᵒ) ∗ᵒ Qᵒ  ⊨ ⇛ᴺᵒ  Pᵒ ∗ᵒ Qᵒ
  ⇛ᴺᵒ-eatʳ =  ∗ᵒ-comm › ⇛ᴺᵒ-eatˡ › ⇛ᴺᵒ-mono ∗ᵒ-comm
