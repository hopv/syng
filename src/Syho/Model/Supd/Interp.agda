...
open import Syho.Model.Prop.Base using (Propᵒ; Monoᵒ; _⊨✓_; _⊨_; ⊨_; ⊨⇒⊨✓;
  ...
  -∗ᵒ-Mono; -∗ᵒ-monoʳ; -∗ᵒ-intro; -∗ᵒ-applyˡ; ⤇ᵒ-intro; ⤇ᴱ-param; ⤇ᴱ-eatʳ;
  ⤇ᴱ-step)
...
abstract
  ...
  ⤇ᵒ⇒⇛ᴺᵒ :  ⤇ᵒ Pᵒ  ⊨ ⇛ᴺᵒ  Pᵒ
  ⤇ᵒ⇒⇛ᴺᵒ =  -∗ᵒ-intro λ _ → ∗ᵒ-monoʳ ⤇ᵒ⇒⇛ᵒ › ⇛ᵒ-eatˡ
  ...
  ⇛ᴺᵒ-eatʳ =  -∗ᵒ-intro λ ✓∙ → ∗ᵒ-assocʳ › ∗ᵒ-mono✓ˡ (-∗ᵒ-applyˡ ⇛ᵒ-Mono) ✓∙ ›
