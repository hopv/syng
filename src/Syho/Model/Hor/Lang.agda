...
open import Syho.Lang.Ktxred using (Ktx; _ᴷ◁_; _ᴷ∘ᴷ_; ndᴿ; ▶ᴿ_; _◁ᴿ_; _⁏ᴿ_;
  forkᴿ; _ᴷ|_; val/ktxred; ᴷ∘ᴷ-ᴷ◁; val/ktxred-ĩ₀; val/ktxred-ktx)
...
abstract
  ...
  … | ĩ₁ (K' ᴷ| _) | _ | ⇒Ke≡KK'red  rewrite ⇒Ke≡KK'red {K = K} refl =  ⁺⟨⟩ᴾᵒ-kr
  ...
  … | ĩ₁ (K' ᴷ| _) | _ | ⇒Ke≡KK'red  rewrite ⇒Ke≡KK'red {K = K} refl =  ⁺⟨⟩ᵀᵒ-kr
