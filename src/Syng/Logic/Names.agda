...
module Syng.Logic.Names where

open import Base.Func using (_$_)
open import Base.Eq using (◠˙_)
open import Base.Size using (𝕊)
open import Base.Zoi using (Zoi; _⊆ᶻ_; _∖ᶻ_; ⊆ᶻ⇒∖-⊎ˡ)
open import Syng.Logic.Prop using (Name; _∗_; _-∗_; [_]ᴺ; [⊤]ᴺ; [^_]ᴺ; ^ᶻᴺ-✔)
open import Syng.Logic.Core using (_⊢[_]_; _»_; ∗-monoʳ; ∗-elimˡ; -∗-introˡ)

-- Import and re-export
open import Syng.Logic.Judg public using ([]ᴺ-resp; []ᴺ-merge; []ᴺ-split; []ᴺ-✔)
