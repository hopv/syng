...
data  Wpᴾ (Pᵒ˙ : Val T → Propᵒ ł) (ι : 𝕊) :  Val/Ktxred T →  Propᵒ (1ᴸ ⊔ᴸ ł)

-- ⁺⟨ ⟩ᴾᵒ :  Semantic partial weakest precondition on Val/Ktxred
-- ⟨ ⟩ᴾᵒ :  ⁺⟨ ⟩ᴾᵒ on Expr
-- ⟨ ⟩ᴾᵒ˂ :  ⟨ ⟩ᴾᵒ˂ under Thunk

⁺⟨_⟩ᴾᵒ :  Val/Ktxred T →  𝕊 →  (Val T → Propᵒ ł) →  Propᵒ (1ᴸ ⊔ᴸ ł)
⁺⟨ kr ⟩ᴾᵒ ι Pᵒ˙ =  Wpᴾ Pᵒ˙ ι kr

⟨_⟩ᴾᵒ ⟨_⟩ᴾᵒ˂ :  Expr∞ T →  𝕊 →  (Val T → Propᵒ ł) →  Propᵒ (1ᴸ ⊔ᴸ ł)
...
data  Wpᴾ⊤ (ι : 𝕊) :  Val/Ktxred (◸ ⊤) →  Propᵒ 1ᴸ

⁺⟨_⟩ᴾᵒ⊤ :  Val/Ktxred (◸ ⊤) →  𝕊 →  Propᵒ 1ᴸ
⁺⟨ vk ⟩ᴾᵒ⊤ ι =  Wpᴾ⊤ ι vk
...
⟨_⟩ᴾᵒ⊤ ⟨_⟩ᴾᵒ⊤˂ :  Expr∞ (◸ ⊤) →  𝕊 →  Propᵒ 1ᴸ
⟨ e ⟩ᴾᵒ⊤ ι =  ⁺⟨ val/ktxred e ⟩ᴾᵒ⊤ ι
⟨ e ⟩ᴾᵒ⊤˂ ι =  Thunkᵒ ⟨ e ⟩ᴾᵒ⊤ ι

⟨¿_⟩ᴾᵒ⊤˂ :  ¿ Expr∞ (◸ ⊤) →  𝕊 →  Propᵒ 1ᴸ
⟨¿ ň ⟩ᴾᵒ⊤˂ _ =  ⊤ᵒ
⟨¿ š e ⟩ᴾᵒ⊤˂ ι =  ⟨ e ⟩ᴾᵒ⊤˂ ι
...
data  Wpᵀ (Pᵒ˙ : Val T → Propᵒ ł) (ι : 𝕊) :  Val/Ktxred T →  Propᵒ (1ᴸ ⊔ᴸ ł)
...
⁺⟨_⟩ᵀᵒ :  Val/Ktxred T →  𝕊 →  (Val T → Propᵒ ł) →  Propᵒ (1ᴸ ⊔ᴸ ł)
⁺⟨ kr ⟩ᵀᵒ ι Pᵒ˙ =  Wpᵀ Pᵒ˙ ι kr

⟨_⟩ᵀᵒ ⟨_⟩ᵀᵒ˂ :  Expr∞ T →  𝕊 →  (Val T → Propᵒ ł) →  Propᵒ (1ᴸ ⊔ᴸ ł)
...
data  Wpᵀ⊤ (ι : 𝕊) :  Val/Ktxred (◸ ⊤) →  Propᵒ 1ᴸ

⁺⟨_⟩ᵀᵒ⊤ :  Val/Ktxred (◸ ⊤) →  𝕊 →  Propᵒ 1ᴸ
⁺⟨ vk ⟩ᵀᵒ⊤ ι =  Wpᵀ⊤ ι vk
...
⟨_⟩ᵀᵒ⊤ ⟨_⟩ᵀᵒ⊤˂ :  Expr∞ (◸ ⊤) →  𝕊 →  Propᵒ 1ᴸ
⟨ e ⟩ᵀᵒ⊤ ι =  ⁺⟨ val/ktxred e ⟩ᵀᵒ⊤ ι
⟨ e ⟩ᵀᵒ⊤˂ ι =  Shrunkᵒ ⟨ e ⟩ᵀᵒ⊤ ι

⟨¿_⟩ᵀᵒ⊤˂ :  ¿ Expr∞ (◸ ⊤) →  𝕊 →  Propᵒ 1ᴸ
⟨¿ ň ⟩ᵀᵒ⊤˂ _ =  ⊤ᵒ
⟨¿ š e ⟩ᵀᵒ⊤˂ ι =  ⟨ e ⟩ᵀᵒ⊤˂ ι
...
data  Wp∞ {T} (ι ι' : 𝕊) :  Val/Ktxred T →  Propᵒ 1ᴸ
...
⁺⟨_⟩∞ᵒ :  Val/Ktxred T →  𝕊 →  𝕊 →  Propᵒ 1ᴸ
⁺⟨ kr ⟩∞ᵒ ι ι' =  Wp∞ ι ι' kr

⟨_⟩∞ᵒ ⟨_⟩∞ᵒ˂ˡ :  Expr∞ T →  𝕊 →  𝕊 →  Propᵒ 1ᴸ
⟨ e ⟩∞ᵒ ι ι' =  ⁺⟨ val/ktxred e ⟩∞ᵒ ι ι'
⟨ e ⟩∞ᵒ˂ˡ ι ι' =  Shrunkᵒ (λ ι⁻ → ⟨ e ⟩∞ᵒ ι⁻ ι') ι

⟨_⟩∞ᵒ˂ʳ :  Expr∞ T →  𝕊 →  Propᵒ 1ᴸ
⟨ e ⟩∞ᵒ˂ʳ ι' =  Thunkᵒ (⟨ e ⟩∞ᵒ ∞) ι'

⟨_⟩∞ᵒ˂⟨_⟩ :  Expr∞ T →  𝔹 →  𝕊 →  𝕊 →  Propᵒ 1ᴸ
