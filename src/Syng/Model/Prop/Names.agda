...
module Syng.Model.Prop.Names where
...
open import Syng.Model.ERA.Names using ([_]ᴺʳ; []ᴺʳ-cong; []ᴺʳ-✔)
open import Syng.Model.ERA.Glob using (iᴺᵃᵐᵉˢ)
open import Syng.Model.Prop.Base using (SPropᵒ; _⊨✓_; _⊨_; ⌜_⌝ᵒ; ⊥ᵒ₀; _∗ᵒ_;
  ◎⟨_⟩_; ◎⟨⟩-resp; ◎⟨⟩-∗ᵒ⇒∙; ◎⟨⟩-∙⇒∗ᵒ; ◎⟨⟩-✓)
