...
module Syng.Model.Prop.Bor where
...
open import Syng.Logic.Prop using (Lft; SProp∞; ⊤'; _∗_; _-∗_; Basic)
open import Syng.Logic.Core using (_⊢[_]_; _»_; ∗-monoˡ; ∗-monoʳ; ∗-comm;
  ∗-assocʳ; ∗?-comm; ∗-elimʳ; -∗-applyˡ)
open import Syng.Model.ERA.Bor using (Envᴮᵒʳᵇ; εᴮᵒʳ; borᵐ; oborᵐ; lend;
  borᵐ-new; borᵐ-open; oborᵐ-close; lend-back)
open import Syng.Model.ERA.Glob using (iᴮᵒʳ)
open import Syng.Model.Prop.Base using (SPropᵒ; Monoᵒ; _⊨✓_; _⊨_; ⊨_; ∃ᵒ-syntax;
  ...
  ◎⟨⟩-∙⇒∗ᵒ; ↝-◎⟨⟩-⤇ᴱ⟨⟩; ε↝-◎⟨⟩-⤇ᴱ⟨⟩)
open import Syng.Model.Prop.Lft using ([_]ᴸ⟨_⟩ᵒ)
