...
module Syng.Model.ERA.Ind where
...
open import Syng.Logic.Prop using (SProp∞)
open import Syng.Model.ERA.Base using (ERA)
open import Syng.Model.ERA.Exc using (Excᴱᴿᴬ; εˣ; #ˣ_; ň-✓ˣ; ✓ˣ-free)
...
module BndIndˣ =  Syng.Model.ERA.Bnd (Excᴱᴿᴬ SProp∞) ň ň-✓ˣ
...
module BndIndᵖ =  Syng.Model.ERA.Bnd (Agᴱᴿᴬ SProp∞) ň (ň-✓ᴸ › ≡⇒≈ᴸ)
