...
module Syng.Model.Fupd.Ind where
...
open import Syng.Lang.Expr using (Type; Expr∞)
open import Syng.Lang.Ktxred using (Redex)
open import Syng.Logic.Prop using (HorKind; SProp∞; _∗_)
open import Syng.Logic.Fupd using (_⊢[_][_]⇛_)
open import Syng.Logic.Hor using (_⊢[_][_]ᵃ⟨_⟩_; _⊢[_]⟨_⟩[_]_; _⊢[_][_]⟨_⟩∞)
open import Syng.Model.ERA.Ind using (Envᴵⁿᵈˣ; Envᴵⁿᵈᵖ; Envᴵⁿᵈ)
open import Syng.Model.ERA.Glob using (Envᴵⁿᴳ; jᴵⁿᵈˣ; jᴵⁿᵈᵖ; ∅ᴵⁿᴳ)
open import Syng.Model.Prop.Base using (SPropᵒ; _⊨_; ⊨_; ∃ᵒ-syntax; ⌜_⌝ᵒ×_;
  ...
  dup-□ᵒ; □ᵒ-∗ᵒ-in)
open import Syng.Model.Prop.Smry using (Smry; Smry-Mono; Smry-0; Smry-add-š;
  Smry-rem-<)
open import Syng.Model.Prop.Ind using (Indˣ; Indᵖ; Ind; ○ᵒ_; _⊸[_]⇛ˢ_;
...
open import Syng.Model.Fupd.Base using ([_]⇛ᵍ_; [_]⇛ᵍ¹_; ⇛ᵍ-mono✓; ⇛ᵍ-mono;
...
-- On ⊸⇛ᵒ, ⊸ᵃ⟨ ⟩ᵒ, ⊸⟨ ⟩ᵒ and ⊸⟨ ⟩∞ᵒ
  ...
  ⊸⇛ᵒ-use :  P ⊸[ i ]⇛ˢ Q  ⊨ ⇛ᴵⁿᵈ  ∃ᵒ R ,  ⌜ P ∗ R ⊢[ ∞ ][ i ]⇛ Q ⌝ᵒ×  ⸨ R ⸩
