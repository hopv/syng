...
module Syng.Logic.Lft where

open import Base.Func using (_$_)
open import Base.Size using (𝕊)
open import Base.Ratp using (ℚ⁺; _/2⁺; /2⁺-merge; /2⁺-split)
open import Syng.Logic.Prop using (Lft; _∗_; [_]ᴸ⟨_⟩; †ᴸ_)
open import Syng.Logic.Core using (_⊢[_]_; Pers; _»_; Pers-⇒□)

-- Import and re-export
open import Syng.Logic.Judg public using ([]ᴸ⟨⟩-resp; []ᴸ⟨⟩-merge; []ᴸ⟨⟩-split;
