...
open import Symp.Lang.Expr using (Type; ◸_; Expr∞; Val; V⇒E; Heap)
...
open import Symp.Model.Fupd.Interp using (⟨_⟩⇛ᴴ'⟨_⟩_; ⟨_⟩⇛ᴴ⟨_⟩_; ⇛ᵒ_; ⇛ᴺᵒ_;
  ⇛ᴴ⇒⇛ᴴ'; ⇛ᴴ'⇒⇛ᴴ; ⇛ᴴ-Mono; ⇛ᵒ-Mono; ⇛ᴴ-mono✓; ⇛ᴴ-mono; ⇛ᵒ-mono✓; ⇛ᵒ-mono;
  ⇛ᴺᵒ-mono✓; ⇛ᴺᵒ-mono; ⊨✓⇒⊨-⇛ᴴ; ⇛ᴺᵒ-intro; ⇛ᴴ-join; ⇛ᴺᵒ-join; ⇛ᴴ-eatˡ; ⇛ᴺᵒ-eatˡ;
  ⇛ᵒ⇒⇛ᴺᵒ)
...
ᵃ⟨ red ⟩ᵒ Pᵒ˙ =  ∀ᵒ H , ⟨ H ⟩⇛ᴴ⟨ H ⟩ ⌜ (red , H) ⇒ᴿ∑ ⌝ᵒ×
                   ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ⌜ (e , eˇ , H') ⇐ᴿ (red , H) ⌝ᵒ→
                     ∃ᵒ v , ⌜ e ≡ V⇒E v × eˇ ≡ ň ⌝ᵒ×  ⟨ H ⟩⇛ᴴ⟨ H' ⟩  Pᵒ˙ v

-- For the type of the data constructors ⁺⟨⟩ᴾᵒ-kr' etc., we use the connectives
-- ⇛ᴴ', -∗ᵒ' and ∗ᵒ' (the concrete version, which exposes the definition
-- publicly) instead of ⇛ᴴ, -∗ᵒ and ∗ᵒ (the abstract version, which hides the
...
data  Wpᴾ⊤ ι  where
  ...
  ⁺⟨⟩ᴾᵒ⊤-kr' :  [⊤]ᴺᵒ -∗ᵒ' ∀ᵒ H , ⟨ H ⟩⇛ᴴ'⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
                  ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ⌜ (e , eˇ , H') ⇐ᴷᴿ (kr , H) ⌝ᵒ→
                    ⟨ H ⟩⇛ᴴ'⟨ H' ⟩ [⊤]ᴺᵒ ∗ᵒ' ⟨ e ⟩ᴾᵒ⊤˂ ι ∗ᵒ' ⟨¿ eˇ ⟩ᴾᵒ⊤˂ ι  ⊨
                ⁺⟨ ĩ₁ kr ⟩ᴾᵒ⊤ ι
...
data  Wpᴾ Pᵒ˙ ι  where
  ...
  ⁺⟨⟩ᴾᵒ-kr' :  [⊤]ᴺᵒ -∗ᵒ' ∀ᵒ H , ⟨ H ⟩⇛ᴴ'⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
                 ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ⌜ (e , eˇ , H') ⇐ᴷᴿ (kr , H) ⌝ᵒ→
                   ⟨ H ⟩⇛ᴴ'⟨ H' ⟩ [⊤]ᴺᵒ ∗ᵒ' ⟨ e ⟩ᴾᵒ˂ ι Pᵒ˙ ∗ᵒ' ⟨¿ eˇ ⟩ᴾᵒ⊤˂ ι  ⊨
               ⁺⟨ ĩ₁ kr ⟩ᴾᵒ ι Pᵒ˙
...
data  Wpᵀ⊤ ι  where
  ...
  ⁺⟨⟩ᵀᵒ⊤-kr' :  [⊤]ᴺᵒ -∗ᵒ' ∀ᵒ H , ⟨ H ⟩⇛ᴴ'⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
                  ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ⌜ (e , eˇ , H') ⇐ᴷᴿ (kr , H) ⌝ᵒ→
                    ⟨ H ⟩⇛ᴴ'⟨ H' ⟩ [⊤]ᴺᵒ ∗ᵒ' ⟨ e ⟩ᵀᵒ⊤˂ ι ∗ᵒ' ⟨¿ eˇ ⟩ᵀᵒ⊤˂ ι  ⊨
                ⁺⟨ ĩ₁ kr ⟩ᵀᵒ⊤ ι
...
data  Wpᵀ Pᵒ˙ ι  where
  ...
  ⁺⟨⟩ᵀᵒ-kr' :  [⊤]ᴺᵒ -∗ᵒ' ∀ᵒ H , ⟨ H ⟩⇛ᴴ'⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
                 ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ⌜ (e , eˇ , H') ⇐ᴷᴿ (kr , H) ⌝ᵒ→
                   ⟨ H ⟩⇛ᴴ'⟨ H' ⟩ [⊤]ᴺᵒ ∗ᵒ' ⟨ e ⟩ᵀᵒ˂ ι Pᵒ˙ ∗ᵒ' ⟨¿ eˇ ⟩ᵀᵒ⊤˂ ι  ⊨
               ⁺⟨ ĩ₁ kr ⟩ᵀᵒ ι Pᵒ˙
...
data  Wp∞ ι ι'  where
  ...
  ⁺⟨⟩∞ᵒ-kr' :  [⊤]ᴺᵒ -∗ᵒ' ∀ᵒ H , ⟨ H ⟩⇛ᴴ'⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
                 ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ∀ᵒ b ,
                   ⌜ (e , eˇ , H') ⇐ᴷᴿ⟨ b ⟩ (kr , H) ⌝ᵒ→ ⟨ H ⟩⇛ᴴ'⟨ H' ⟩
...
abstract
  ...
  ⁺⟨⟩ᴾᵒ-kr :  [⊤]ᴺᵒ -∗ᵒ ∀ᵒ H , ⟨ H ⟩⇛ᴴ⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
                ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ⌜ (e , eˇ , H') ⇐ᴷᴿ (kr , H) ⌝ᵒ→
                  ⟨ H ⟩⇛ᴴ⟨ H' ⟩ [⊤]ᴺᵒ ∗ᵒ ⟨ e ⟩ᴾᵒ˂ ι Pᵒ˙ ∗ᵒ ⟨¿ eˇ ⟩ᴾᵒ⊤˂ ι  ⊨
              ⁺⟨ ĩ₁ kr ⟩ᴾᵒ ι Pᵒ˙
  ⁺⟨⟩ᴾᵒ-kr big =  ⁺⟨⟩ᴾᵒ-kr' $ big ▷ -∗ᵒ-monoʳ (λ big H → big H ▷ (⇛ᴴ-mono
    λ (krH⇒ , big) → krH⇒ , λ e eˇ H' eeˇH'⇐ → big e eˇ H' eeˇH'⇐ ▷
    ⇛ᴴ-mono (∗ᵒ-monoʳ ∗ᵒ⇒∗ᵒ' › ∗ᵒ⇒∗ᵒ') ▷ ⇛ᴴ⇒⇛ᴴ') ▷ ⇛ᴴ⇒⇛ᴴ') ▷ -∗ᵒ⇒-∗ᵒ'

  ⁺⟨⟩ᵀᵒ-kr :  [⊤]ᴺᵒ -∗ᵒ ∀ᵒ H , ⟨ H ⟩⇛ᴴ⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
                ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ⌜ (e , eˇ , H') ⇐ᴷᴿ (kr , H) ⌝ᵒ→
                  ⟨ H ⟩⇛ᴴ⟨ H' ⟩ [⊤]ᴺᵒ ∗ᵒ ⟨ e ⟩ᵀᵒ˂ ι Pᵒ˙ ∗ᵒ ⟨¿ eˇ ⟩ᵀᵒ⊤˂ ι  ⊨
              ⁺⟨ ĩ₁ kr ⟩ᵀᵒ ι Pᵒ˙
  ⁺⟨⟩ᵀᵒ-kr big =  ⁺⟨⟩ᵀᵒ-kr' $ big ▷ -∗ᵒ-monoʳ (λ big H → big H ▷ (⇛ᴴ-mono
    λ (krH⇒ , big) → krH⇒ , λ e eˇ H' eeˇH'⇐ → big e eˇ H' eeˇH'⇐ ▷
    ⇛ᴴ-mono (∗ᵒ-monoʳ ∗ᵒ⇒∗ᵒ' › ∗ᵒ⇒∗ᵒ') ▷ ⇛ᴴ⇒⇛ᴴ') ▷ ⇛ᴴ⇒⇛ᴴ') ▷ -∗ᵒ⇒-∗ᵒ'
  ...
  ⁺⟨⟩∞ᵒ-kr :  [⊤]ᴺᵒ -∗ᵒ ∀ᵒ H , ⟨ H ⟩⇛ᴴ⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
                ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ∀ᵒ b ,
                  ⌜ (e , eˇ , H') ⇐ᴷᴿ⟨ b ⟩ (kr , H) ⌝ᵒ→ ⟨ H ⟩⇛ᴴ⟨ H' ⟩
                    [⊤]ᴺᵒ ∗ᵒ ⟨ e ⟩∞ᵒ˂⟨ b ⟩ ι ι' ∗ᵒ ⟨¿ eˇ ⟩ᵀᵒ⊤˂ ι  ⊨
              ⁺⟨ ĩ₁ kr ⟩∞ᵒ ι ι'
  ⁺⟨⟩∞ᵒ-kr big =  ⁺⟨⟩∞ᵒ-kr' $ big ▷ -∗ᵒ-monoʳ (λ big H → big H ▷ (⇛ᴴ-mono
  ...
  ⁺⟨⟩ᴾᵒ-kr⁻¹ :  ⁺⟨ ĩ₁ kr ⟩ᴾᵒ ι Pᵒ˙  ⊨
                [⊤]ᴺᵒ -∗ᵒ ∀ᵒ H , ⟨ H ⟩⇛ᴴ⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
                  ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ⌜ (e , eˇ , H') ⇐ᴷᴿ (kr , H) ⌝ᵒ→
                    ⟨ H ⟩⇛ᴴ⟨ H' ⟩ [⊤]ᴺᵒ ∗ᵒ ⟨ e ⟩ᴾᵒ˂ ι Pᵒ˙ ∗ᵒ ⟨¿ eˇ ⟩ᴾᵒ⊤˂ ι
  ⁺⟨⟩ᴾᵒ-kr⁻¹ (⁺⟨⟩ᴾᵒ-kr' big) =  big ▷ -∗ᵒ'⇒-∗ᵒ {Qᵒ = ∀ᵒ H , ⟨ H ⟩⇛ᴴ'⟨ H ⟩ _} ▷
    -∗ᵒ-monoʳ λ big H → big H ▷ ⇛ᴴ'⇒⇛ᴴ ▷ ⇛ᴴ-mono λ (krH⇒ , big) → krH⇒ ,
    λ e eˇ H' eeˇH'⇐ → big e eˇ H' eeˇH'⇐ ▷ ⇛ᴴ'⇒⇛ᴴ ▷
    ⇛ᴴ-mono (∗ᵒ'⇒∗ᵒ › ∗ᵒ-monoʳ ∗ᵒ'⇒∗ᵒ)

  ⁺⟨⟩ᵀᵒ-kr⁻¹ :  ⁺⟨ ĩ₁ kr ⟩ᵀᵒ ι Pᵒ˙  ⊨
                [⊤]ᴺᵒ -∗ᵒ ∀ᵒ H , ⟨ H ⟩⇛ᴴ⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
                  ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ⌜ (e , eˇ , H') ⇐ᴷᴿ (kr , H) ⌝ᵒ→
                    ⟨ H ⟩⇛ᴴ⟨ H' ⟩ [⊤]ᴺᵒ ∗ᵒ ⟨ e ⟩ᵀᵒ˂ ι Pᵒ˙ ∗ᵒ ⟨¿ eˇ ⟩ᵀᵒ⊤˂ ι
  ⁺⟨⟩ᵀᵒ-kr⁻¹ (⁺⟨⟩ᵀᵒ-kr' big) =  big ▷ -∗ᵒ'⇒-∗ᵒ {Qᵒ = ∀ᵒ H , ⟨ H ⟩⇛ᴴ'⟨ H ⟩ _} ▷
    -∗ᵒ-monoʳ λ big H → big H ▷ ⇛ᴴ'⇒⇛ᴴ ▷ ⇛ᴴ-mono λ (krH⇒ , big) → krH⇒ ,
    λ e eˇ H' eeˇH'⇐ → big e eˇ H' eeˇH'⇐ ▷ ⇛ᴴ'⇒⇛ᴴ ▷
    ⇛ᴴ-mono (∗ᵒ'⇒∗ᵒ › ∗ᵒ-monoʳ ∗ᵒ'⇒∗ᵒ)
  ...
  ⁺⟨⟩∞ᵒ-kr⁻¹ :  ⁺⟨ ĩ₁ kr ⟩∞ᵒ ι ι'  ⊨
                [⊤]ᴺᵒ -∗ᵒ ∀ᵒ H , ⟨ H ⟩⇛ᴴ⟨ H ⟩ ⌜ (kr , H) ⇒ᴷᴿ∑ ⌝ᵒ×
                  ∀ᵒ e , ∀ᵒ eˇ , ∀ᵒ H' , ∀ᵒ b ,
                    ⌜ (e , eˇ , H') ⇐ᴷᴿ⟨ b ⟩ (kr , H) ⌝ᵒ→ ⟨ H ⟩⇛ᴴ⟨ H' ⟩
                      [⊤]ᴺᵒ ∗ᵒ ⟨ e ⟩∞ᵒ˂⟨ b ⟩ ι ι' ∗ᵒ ⟨¿ eˇ ⟩ᵀᵒ⊤˂ ι
  ⁺⟨⟩∞ᵒ-kr⁻¹ (⁺⟨⟩∞ᵒ-kr' big) =  big ▷ -∗ᵒ'⇒-∗ᵒ {Qᵒ = ∀ᵒ H , ⟨ H ⟩⇛ᴴ'⟨ H ⟩ _} ▷
    -∗ᵒ-monoʳ λ big H → big H ▷ ⇛ᴴ'⇒⇛ᴴ ▷ ⇛ᴴ-mono λ (krH⇒ , big) → krH⇒ ,
    λ e eˇ H' b eeˇH'⇐⟨b⟩ → big e eˇ H' b eeˇH'⇐⟨b⟩ ▷ ⇛ᴴ'⇒⇛ᴴ ▷
    ⇛ᴴ-mono (∗ᵒ'⇒∗ᵒ › ∗ᵒ-monoʳ ∗ᵒ'⇒∗ᵒ)
  ...
  ⁺⟨⟩ᴾᵒ⊤⇒⁺⟨⟩ᴾᵒ (⁺⟨⟩ᴾᵒ⊤-kr' big) =  ⁺⟨⟩ᴾᵒ-kr $ big ▷
    -∗ᵒ'⇒-∗ᵒ {Qᵒ = ∀ᵒ H , ⟨ H ⟩⇛ᴴ'⟨ H ⟩ _} ▷ -∗ᵒ-monoʳ λ big H → big H ▷
    ⇛ᴴ'⇒⇛ᴴ ▷ ⇛ᴴ-mono λ (krH⇒ , big) → krH⇒ , λ e eˇ H' eeˇH'⇐ →
    big e eˇ H' eeˇH'⇐ ▷ ⇛ᴴ'⇒⇛ᴴ ▷ ⇛ᴴ-mono (∗ᵒ'⇒∗ᵒ › ∗ᵒ-monoʳ $ ∗ᵒ'⇒∗ᵒ ›
  ...
  ⁺⟨⟩ᴾᵒ⇒⁺⟨⟩ᴾᵒ⊤ {vk = ĩ₁ _} ⟨kr⟩P =  ⁺⟨⟩ᴾᵒ⊤-kr' $ ⁺⟨⟩ᴾᵒ-kr⁻¹ ⟨kr⟩P ▷ -∗ᵒ-monoʳ
    (λ big H → big H ▷ ⇛ᴴ-mono (λ (krH⇒ , big) → krH⇒ , λ e eˇ H' eeˇH'⇐ →
    big e eˇ H' eeˇH'⇐ ▷ ⇛ᴴ-mono (∗ᵒ-monoʳ (∗ᵒ-monoˡ {Qᵒ = ⟨ _ ⟩ᴾᵒ⊤˂ _} (λ big →
    λ{ .! {ι'} → ⁺⟨⟩ᴾᵒ⇒⁺⟨⟩ᴾᵒ⊤ (big .! {ι'}) }) › ∗ᵒ⇒∗ᵒ') › ∗ᵒ⇒∗ᵒ') ▷ ⇛ᴴ⇒⇛ᴴ') ▷
    ⇛ᴴ⇒⇛ᴴ') ▷ -∗ᵒ⇒-∗ᵒ'

  ⁺⟨⟩ᵀᵒ⇒⁺⟨⟩ᵀᵒ⊤ :  ⁺⟨ vk ⟩ᵀᵒ ι Pᵒ˙  ⊨  ⁺⟨ vk ⟩ᵀᵒ⊤ ι
  ⁺⟨⟩ᵀᵒ⇒⁺⟨⟩ᵀᵒ⊤ {vk = ĩ₀ _} _ =  ⁺⟨⟩ᵀᵒ⊤-val
  ⁺⟨⟩ᵀᵒ⇒⁺⟨⟩ᵀᵒ⊤ {vk = ĩ₁ _} {ι} ⟨kr⟩P =  ⁺⟨⟩ᵀᵒ⊤-kr' $ ⁺⟨⟩ᵀᵒ-kr⁻¹ ⟨kr⟩P ▷
    -∗ᵒ-monoʳ (λ big H → big H ▷ ⇛ᴴ-mono (λ (krH⇒ , big) → krH⇒ ,
    λ e eˇ H' eeˇH'⇐ → big e eˇ H' eeˇH'⇐ ▷ ⇛ᴴ-mono (∗ᵒ-monoʳ (∗ᵒ-monoˡ
  ...
  ᵃ⟨⟩ᵒ-Mono a⊑b ⟨red⟩P H =  ⟨red⟩P H ▷ ⇛ᴴ-Mono a⊑b
  ...
  -- Utility :  Monoᵒ for ∀ᵒ ⇛ᴴ

  ∀ᵒ⇛ᴴ-Mono :  Monoᵒ $ ∀ᵒ H , ⟨ H ⟩⇛ᴴ⟨ H ⟩ Pᵒ˙ H
  ∀ᵒ⇛ᴴ-Mono =  ∀ᵒ-Mono λ _ → ⇛ᴴ-Mono

  -- Monotonicity of ᵃ⟨⟩ᵒ and ⁺⟨⟩ᴾ/ᵀᵒ

  ᵃ⟨⟩ᵒ-mono✓ :  (∀ v → Pᵒ˙ v ⊨✓ Qᵒ˙ v) →  ᵃ⟨ red ⟩ᵒ Pᵒ˙ ⊨ ᵃ⟨ red ⟩ᵒ Qᵒ˙
  ᵃ⟨⟩ᵒ-mono✓ Pv⊨✓Qv big H =  big H ▷ ⇛ᴴ-mono λ (redH⇒ , big) → redH⇒ ,
  ...
  ⁺⟨⟩ᴾᵒ-mono✓ {vk = ĩ₀ _} Pv⊨✓Qv =  ⁺⟨⟩ᴾᵒ-val⁻¹ › ⇛ᴺᵒ-mono✓ (Pv⊨✓Qv _) ›
    ⁺⟨⟩ᴾᵒ-val
  ⁺⟨⟩ᴾᵒ-mono✓ {vk = ĩ₁ _} Pv⊨✓Qv =  ⁺⟨⟩ᴾᵒ-kr⁻¹ › -∗ᵒ-monoʳ (λ big H → big H ▷
    ⇛ᴴ-mono λ (krH⇒ , big) → krH⇒ , λ e eˇ H' eeˇH'⇐ → big e eˇ H' eeˇH'⇐ ▷
    ⇛ᴴ-mono (∗ᵒ-monoʳ $ ∗ᵒ-monoˡ λ big →
  ...
  ⁺⟨⟩ᵀᵒ-mono✓ {vk = ĩ₀ _} Pv⊨✓Qv =  ⁺⟨⟩ᵀᵒ-val⁻¹ › ⇛ᴺᵒ-mono✓ (Pv⊨✓Qv _) ›
    ⁺⟨⟩ᵀᵒ-val
  ⁺⟨⟩ᵀᵒ-mono✓ {vk = ĩ₁ _} Pv⊨✓Qv =  ⁺⟨⟩ᵀᵒ-kr⁻¹ › -∗ᵒ-monoʳ (λ big H → big H ▷
    ⇛ᴴ-mono λ (krH⇒ , big) → krH⇒ , λ e eˇ H' eeˇH'⇐ → big e eˇ H' eeˇH'⇐ ▷
    ⇛ᴴ-mono (∗ᵒ-monoʳ $ ∗ᵒ-monoˡ λ{ (§ big) → § ⁺⟨⟩ᵀᵒ-mono✓ Pv⊨✓Qv big })) ›
    ⁺⟨⟩ᵀᵒ-kr
  ...
  ⊨✓⇒⊨-ᵃ⟨⟩ᵒ P⊨✓⟨red⟩Q Pa H =  Pa ▷ ⊨✓⇒⊨-⇛ᴴ (λ ✓∙ Pb → P⊨✓⟨red⟩Q ✓∙ Pb H)
  ...
  ⁺⟨⟩ᵀᵒ⇒⁺⟨⟩ᴾᵒ {vk = ĩ₁ _} =  ⁺⟨⟩ᵀᵒ-kr⁻¹ › (-∗ᵒ-monoʳ λ big H → big H ▷ ⇛ᴴ-mono
    λ (krH⇒ , big) → krH⇒ , λ e eˇ H' eeˇH'⇐ → big e eˇ H' eeˇH'⇐ ▷
    ⇛ᴴ-mono (∗ᵒ-monoʳ $ ∗ᵒ-mono (λ{ (§ big) → λ{ .! → ⁺⟨⟩ᵀᵒ⇒⁺⟨⟩ᴾᵒ big }}) $
    ⟨¿⟩ᵀᵒ⊤˂⇒⟨¿⟩ᴾᵒ⊤˂ {eˇ = eˇ})) › ⁺⟨⟩ᴾᵒ-kr
  ...
  ⁺⟨⟩∞ᵒ⇒⁺⟨⟩ᴾᵒ {vk = ĩ₁ _} =  ⁺⟨⟩∞ᵒ-kr⁻¹ › (-∗ᵒ-monoʳ λ big H →
    big H ▷ ⇛ᴴ-mono λ (krH⇒ , big) → krH⇒ , λ e eˇ H' → λ{
    (ff , eeˇH'⇐○) → big e eˇ H' ff eeˇH'⇐○ ▷ ⇛ᴴ-mono (∗ᵒ-monoʳ $
      ∗ᵒ-mono (λ{ (§ big) → λ{ .! → ⁺⟨⟩∞ᵒ⇒⁺⟨⟩ᴾᵒ big }}) $
      ⟨¿⟩ᵀᵒ⊤˂⇒⟨¿⟩ᴾᵒ⊤˂ {eˇ = eˇ});
    (tt , eeˇH'⇐●) → big e eˇ H' tt eeˇH'⇐● ▷ ⇛ᴴ-mono (∗ᵒ-monoʳ $
      ∗ᵒ-mono (λ big → λ{ .! → ⁺⟨⟩∞ᵒ⇒⁺⟨⟩ᴾᵒ $ big .! }) $
      ⟨¿⟩ᵀᵒ⊤˂⇒⟨¿⟩ᴾᵒ⊤˂ {eˇ = eˇ})}) › ⁺⟨⟩ᴾᵒ-kr
  ...
  ⇛ᵒ-ᵃ⟨⟩ᵒ big H =  big H ▷ ⇛ᴴ-mono (_$ H) ▷ ⇛ᴴ-join

  -- ⁺⟨⟩ᴾ/ᵀᵒ / ⁺⟨⟩∞ᵒ absorbs ⇛ᴺᵒ/⇛ᵒ outside

  ⇛ᴺᵒ-⁺⟨⟩ᴾᵒ :  ⇛ᴺᵒ ⁺⟨ vk ⟩ᴾᵒ ι Pᵒ˙  ⊨  ⁺⟨ vk ⟩ᴾᵒ ι Pᵒ˙
  ⇛ᴺᵒ-⁺⟨⟩ᴾᵒ {vk = ĩ₀ _} =  ⇛ᴺᵒ-mono ⁺⟨⟩ᴾᵒ-val⁻¹ › ⇛ᴺᵒ-join › ⁺⟨⟩ᴾᵒ-val
  ⇛ᴺᵒ-⁺⟨⟩ᴾᵒ {vk = ĩ₁ _} =  (-∗ᵒ-monoʳ λ big H → big H ▷ ⇛ᴴ-mono✓ (λ ✓∙ →
    ∗ᵒ-monoʳ ⁺⟨⟩ᴾᵒ-kr⁻¹ › -∗ᵒ-applyˡ ∀ᵒ⇛ᴴ-Mono ✓∙ › _$ H) ▷ ⇛ᴴ-join) › ⁺⟨⟩ᴾᵒ-kr
  ...
  ⇛ᴺᵒ-⁺⟨⟩ᵀᵒ {vk = ĩ₁ _} =  (-∗ᵒ-monoʳ λ big H → big H ▷ ⇛ᴴ-mono✓ (λ ✓∙ →
    ∗ᵒ-monoʳ ⁺⟨⟩ᵀᵒ-kr⁻¹ › -∗ᵒ-applyˡ ∀ᵒ⇛ᴴ-Mono ✓∙ › _$ H) ▷ ⇛ᴴ-join) › ⁺⟨⟩ᵀᵒ-kr
  ...
  ⇛ᴺᵒ-⁺⟨⟩∞ᵒ {vk = ĩ₁ _} =  (-∗ᵒ-monoʳ λ big H → big H ▷ ⇛ᴴ-mono✓ (λ ✓∙ →
    ∗ᵒ-monoʳ ⁺⟨⟩∞ᵒ-kr⁻¹ › -∗ᵒ-applyˡ ∀ᵒ⇛ᴴ-Mono ✓∙ › _$ H) ▷ ⇛ᴴ-join) › ⁺⟨⟩∞ᵒ-kr
  ...
  ᵃ⟨⟩ᵒ-⇛ᵒ big H =  big H ▷ ⇛ᴴ-mono λ (redH⇒ , big) → redH⇒ , λ e eˇ H' eeˇH'⇐ →
    big e eˇ H' eeˇH'⇐ ▷ λ (-, ≡vň , big) → -, ≡vň ,
    big ▷ ⇛ᴴ-mono (_$ H') ▷ ⇛ᴴ-join

  -- ⁺⟨⟩ᴾ/ᵀᵒ absorbs ⇛ᴺᵒ/⇛ᵒ inside

  ⁺⟨⟩ᴾᵒ-⇛ᴺᵒ :  ⁺⟨ vk ⟩ᴾᵒ ι (λ v → ⇛ᴺᵒ Pᵒ˙ v)  ⊨  ⁺⟨ vk ⟩ᴾᵒ ι Pᵒ˙
  ⁺⟨⟩ᴾᵒ-⇛ᴺᵒ {vk = ĩ₀ _} =  ⁺⟨⟩ᴾᵒ-val⁻¹ › ⇛ᴺᵒ-join › ⁺⟨⟩ᴾᵒ-val
  ⁺⟨⟩ᴾᵒ-⇛ᴺᵒ {vk = ĩ₁ _} =  ⁺⟨⟩ᴾᵒ-kr⁻¹ › (-∗ᵒ-monoʳ λ big H → big H ▷
    ⇛ᴴ-mono λ (krH⇒ , big) → krH⇒ , λ e eˇ H' eeˇH'⇐ → big e eˇ H' eeˇH'⇐ ▷
    ⇛ᴴ-mono (∗ᵒ-monoʳ $ ∗ᵒ-monoˡ λ big → λ{ .! → ⁺⟨⟩ᴾᵒ-⇛ᴺᵒ $ big .! })) ›
    ⁺⟨⟩ᴾᵒ-kr
  ...
  ⁺⟨⟩ᵀᵒ-⇛ᴺᵒ {vk = ĩ₁ _} =  ⁺⟨⟩ᵀᵒ-kr⁻¹ › (-∗ᵒ-monoʳ λ big H → big H ▷
    ⇛ᴴ-mono λ (krH⇒ , big) → krH⇒ , λ e eˇ H' eeˇH'⇐ → big e eˇ H' eeˇH'⇐ ▷
    ⇛ᴴ-mono (∗ᵒ-monoʳ $ ∗ᵒ-monoˡ λ{ (§ big) → § ⁺⟨⟩ᵀᵒ-⇛ᴺᵒ big })) › ⁺⟨⟩ᵀᵒ-kr
  ...
  ᵃ⟨⟩ᵒ-eatˡ big H =  big ▷ ∗ᵒ-monoʳ (_$ H) ▷ ⇛ᴴ-eatˡ ▷ ⇛ᴴ-mono (∗ᵒ∃ᵒ-out ›
    λ (redH⇒ , big) → redH⇒ , λ e eˇ H' eeˇH'⇐ → big ▷
    ∗ᵒ-monoʳ (λ big → big e eˇ H' eeˇH'⇐) ▷ ∗ᵒ∃ᵒ-out ▷ λ (-, big) → -,
    big ▷ ∗ᵒ∃ᵒ-out ▷ λ (≡vň , big) → ≡vň , big ▷ ⇛ᴴ-eatˡ)

  ⁺⟨⟩ᴾᵒ-eatˡ :  Qᵒ ∗ᵒ (⁺⟨ vk ⟩ᴾᵒ ι Pᵒ˙)  ⊨  ⁺⟨ vk ⟩ᴾᵒ ι λ v → Qᵒ ∗ᵒ Pᵒ˙ v
  ⁺⟨⟩ᴾᵒ-eatˡ {vk = ĩ₀ _} =  ∗ᵒ-monoʳ ⁺⟨⟩ᴾᵒ-val⁻¹ › ⇛ᴺᵒ-eatˡ › ⁺⟨⟩ᴾᵒ-val
  ⁺⟨⟩ᴾᵒ-eatˡ {vk = ĩ₁ _} =  ∗ᵒ-monoʳ ⁺⟨⟩ᴾᵒ-kr⁻¹ › -∗ᵒ-eatˡ ∀ᵒ⇛ᴴ-Mono ›
    -∗ᵒ-monoʳ (λ big H → big ▷ ∗ᵒ-monoʳ (_$ H) ▷ ⇛ᴴ-eatˡ ▷ ⇛ᴴ-mono (∗ᵒ∃ᵒ-out ›
    λ (krH⇒ , big) → krH⇒ , λ e eˇ H' eeˇH'⇐ → big ▷
    ∗ᵒ-monoʳ (λ big → big e eˇ H' eeˇH'⇐) ▷ ⇛ᴴ-eatˡ ▷ ⇛ᴴ-mono (?∗ᵒ-comm ›
  ...
  ⁺⟨⟩ᵀᵒ-eatˡ {vk = ĩ₁ _} =  ∗ᵒ-monoʳ ⁺⟨⟩ᵀᵒ-kr⁻¹ › -∗ᵒ-eatˡ ∀ᵒ⇛ᴴ-Mono ›
    -∗ᵒ-monoʳ (λ big H → big ▷ ∗ᵒ-monoʳ (_$ H) ▷ ⇛ᴴ-eatˡ ▷ ⇛ᴴ-mono (∗ᵒ∃ᵒ-out ›
    λ (krH⇒ , big) → krH⇒ , λ e eˇ H' eeˇH'⇐ → big ▷
    ∗ᵒ-monoʳ (λ big → big e eˇ H' eeˇH'⇐) ▷ ⇛ᴴ-eatˡ ▷ ⇛ᴴ-mono (?∗ᵒ-comm ›
