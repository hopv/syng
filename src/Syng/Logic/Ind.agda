...
open import Syng.Logic.Prop using (HorKind; SProp∞; SProp˂∞; ¡ᴾ_; ∀-syntax; _∗_;
  _-∗_; □_; ○_; _⊸[_]⇛_; _⊸[_]ᵃ⟨_⟩_; _⊸⟨_⟩[_]_; _⊸⟨_⟩ᴾ_; _⊸⟨_⟩ᵀ[_]_; _⊸[_]⟨_⟩∞;
  Basic)
open import Syng.Logic.Core using (_⊢[_]_; _⊢[<_]_; Pers; ⇒<; ⊢-refl; _»_;
  ∗-comm; ∗-elimʳ; ⊤∗-intro; -∗-monoʳ; -∗-elimˡ; -∗-const; Pers-⇒□)
open import Syng.Logic.Fupd using ([_]⇛_; _⊢[_][_]⇛_; _⊢[<_][_]⇛_; _⊢[<_][_]⇛ᴺ_;
  ⇒⇛; _ᵘ»_; _»ᵘᴺ_; ⇛⇒⇛ᴺ)

-- Import and re-export
open import Syng.Logic.Judg public using (○-mono; ○-eatˡ; ○-new; □○-new-rec;
