...
module Syng.Model.Prop.Ind where
...
open import Syng.Lang.Expr using (Type; Expr∞; Val)
open import Syng.Lang.Ktxred using (Redex)
open import Syng.Logic.Prop using (HorKind; par; tot; SProp∞; ⊤'; _∗_; Basic)
open import Syng.Logic.Core using (_⊢[_]_; _»_; ∗-assocˡ; ∗-assocʳ; ∗-monoˡ;
  ∗-monoʳ; ?∗-comm; ∗-elimʳ)
open import Syng.Logic.Fupd using (_⊢[_][_]⇛_; _⊢[_][_]⇛ᴺ_; ⇛-≤; _ᵘ»_; _ᵘ»ᵘ_;
  ⇛-frameˡ; ⇛-frameʳ; ⇛ᴺ-frameˡ)
open import Syng.Logic.Hor using (_⊢[_][_]ᵃ⟨_⟩_; _⊢[_]⟨_⟩[_]_; _⊢[_]⟨_⟩ᴾ_;
...
open import Syng.Model.ERA.Ind using (εᴵⁿᵈˣ; indˣ; indᵖ; indˣ-new; indˣ-use;
  indᵖ-new; indᵖ-use)
open import Syng.Model.ERA.Glob using (iᴵⁿᵈˣ; iᴵⁿᵈᵖ)
open import Syng.Model.Prop.Base using (SPropᵒ; Monoᵒ; _⊨_; ⊨_; ∃ᵒ-syntax;
